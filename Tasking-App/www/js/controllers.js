angular.module('starter.controllers', ["ionic.natives"])

.controller('DashCtrl', function($scope) {$scope.openBrowser = function=(){
    $cordovaInAppBrowser.create("https://www.google.com");
  }})

.controller('TasksCtrl', function($scope, Tasks, $ionicModal, $cordovaInAppBrowser) {
